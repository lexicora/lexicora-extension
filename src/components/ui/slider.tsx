  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="bg-gray-300 dark:bg-muted rounded-full data-horizontal:h-1.5 data-vertical:w-1.5 relative grow overflow-hidden data-horizontal:w-full data-vertical:h-full"
      >
