...
function TopicEntriesPage() {
  ...
  return (
    <PageContainer id="lc-topic-entries-page">
      ...
      {!topicIsArchived && !isWindowed && (
        <div className="fixed bottom-15.5 left-(--lc-host-inset-left,0px) right-0 transition-[left] duration-200 ease-linear px-3 pr-[calc(var(--lc-scrollbar-offset)+2px)] z-20 pointer-events-none">
