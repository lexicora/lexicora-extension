...
function LibraryPage() {
  ...
  return (
    <PageContainer className="pb-1.75!" isWindowed={isWindowed}>
      ...
      {!isWindowed && (
        <div className="fixed bottom-15.5 left-(--lc-host-inset-left,0px) right-0 transition-[left] duration-200 ease-linear px-3 pr-[calc(var(--lc-scrollbar-offset)+2px)] /*WAS:pr-[calc(var(--lc-scrollbar-offset)+7px)]*/ z-20 pointer-events-none">
          {/* Was bottom-17.75, changed because of: SIDE_PANEL_NEW_BOTTOM_NAV_STYLE*/}
